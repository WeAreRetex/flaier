...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 border-b border-red-400/35 bg-red-400/10 px-3 py-2">
      <span class="text-sm font-medium text-foreground">{{ label }}</span>
      <span class="rounded-full border border-red-400/45 bg-red-400/18 px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wider text-red-200">
        Error
      </span>
    </div>
    ...
    <div class="space-y-2 px-3 py-2.5">
      ...
      <div v-if="code" class="inline-flex items-center rounded-md border border-red-400/35 bg-red-400/12 px-2 py-0.5 text-[10px] font-mono text-red-100">
        {{ code }}
      </div>
